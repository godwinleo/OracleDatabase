...
accept source_table char prompt 'Source Table : '
accept filter char prompt 'Filter : '
...
declare
	...
	v_source_table varchar2(30) := '&source_table';
	v_filter clob := '&filter';
    ...
    v_row  PLS_INTEGER;
begin
	v_job_name := 'IMP_'||v_source_owner||'@'||v_network_link;
