...
declare
    ...
    v_row  PLS_INTEGER;
begin
	v_job_name := 'IMP_GTBC_DW\@'||v_network_link;
	...
	*/
	...
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BALANCES', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BALANCES_H', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BAL_DAILY', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BAL_DAILY_H', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_MOVEMENTS', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_MOVEMENTS_H', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_CONTRACT_LEG_BALANCES', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_CONTRACT_LEG_BALANCES_H', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_CUSTOMER_ACCT_MOVEMENTS', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_CUSTOMER_ACCT_MOVEMENTS_H', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_REVALUATED_CONTRACTS', 'GTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_REVALUATED_CONTRACTS_H', 'GTBC_DW');
