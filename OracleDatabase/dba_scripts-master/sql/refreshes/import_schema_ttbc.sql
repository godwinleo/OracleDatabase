...
declare
    ...
    v_row  PLS_INTEGER;
begin
	v_job_name := 'IMP_TTBC_DW\@'||v_network_link;
	...
	*/
	...
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BALANCES', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BALANCES_H', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BAL_DAILY', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_BAL_DAILY_H', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_MOVEMENTS', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_ACCOUNT_MOVEMENTS_H', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_CONTRACT_LEG_BALANCES', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'DW_CONTRACT_LEG_BALANCES_H', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_CUSTOMER_ACCT_MOVEMENTS', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_CUSTOMER_ACCT_MOVEMENTS_H', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_REVALUATED_CONTRACTS', 'TTBC_DW');
	DBMS_DATAPUMP.DATA_FILTER (v_dp_job, 'SUBQUERY', 'WHERE BOOK_DATE >= add_months(trunc(sysdate,''MM''),0)', 'RD_REVALUATED_CONTRACTS_H', 'TTBC_DW');
