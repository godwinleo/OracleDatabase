...
select part.table_owner||'.'||part.table_name tab,part.partition_name,part.tablespace_name,subpartition_count subps,nvl(seg.extents,0) extents,part.last_analyzed,nvl(seg.bytes/1024/1024,0) MB, NUM_ROWS
