...
select df.file_id,df.file_name,df.bytes/1024/1024 MB,df.autoextensible
,df.INCREMENT_BY*tb.block_size/1024/1024 NEXT_MB,df.maxbytes/1024/1024 MAX_MB
,df.status,df.blocks,df.maxblocks
from 
   dba_tablespaces tb
   , dba_data_files df
   , v$datafile df2
