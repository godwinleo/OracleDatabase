...
col NEW_ALOC_round for 9,999,999
col INC_ALOC_round2 for 9,999,999
break on report
...
,ceil(USED_BYTES/(80/100)/1024/1024/100)*100 NEW_ALOC_round
--,ceil((aloc.max_size-USED_BYTES/(80/100)/100)/1024/1024/100)*100 INC_ALOC_round
,ceil(USED_BYTES/(80/100)/1024/1024/100)*100 - round(nvl(aloc.max_size/1024/1024,0),2) INC_ALOC_round2
...
and tb.tablespace_name like upper ('&tbs')
