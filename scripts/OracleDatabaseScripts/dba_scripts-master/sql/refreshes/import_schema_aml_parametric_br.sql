...
declare
    ...
    v_row  PLS_INTEGER;
begin
	v_job_name := 'IMP_parametric_BR\@'||v_network_link;
...
,''TXN_CODES''
,''AML_PARAMETERS''
,''MNT_CHANNEL_TYPE_GCG''
,''MNT_COUNTRIES''
,''MNT_COUNTRIES_GCG''
,''MNT_CURRENCY_CODES''
,''MNT_FILE_NAMES''
,''MNT_JURISDICTION''
,''MNT_JURISDICTION_GCG''
,''MNT_MAILLIST''
,''MNT_MARITIAL_STATUS''
,''MNT_MARITIAL_STATUS_GCG''
,''MNT_NATIONALITIES''
,''MNT_NATIONALITIES_GCG''
,''MNT_PRODUCT_TYPE''
,''MNT_PRODUCT_TYPE_GCG''
,''MNT_PROFESSION_CODES''
,''MNT_TXN_CODES''
,''MNT_TXN_CODES_GCG''
,''MNT_TXN_TYPE''
,''MNT_TXN_TYPE_GCG''
