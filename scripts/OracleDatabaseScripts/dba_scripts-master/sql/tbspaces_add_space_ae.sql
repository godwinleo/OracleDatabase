...
,round(USED_BYTES/(75/100)/1024/1024,2) NEW_ALOC_MB
,ceil(USED_BYTES/(75/100)/1024/1024/100)*100 NEW_ALOC_round
...
and round((aloc.max_size-USED_BYTES)/aloc.max_size*100,2) < 25
